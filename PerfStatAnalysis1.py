...
data = pd.read_csv("PerfRootkit2.csv", nrows=1000)
...
data = data[["Instruct", "Cache Miss", "Branch Miss", "Cache R", "Cache W", "LL1 Data C", "LL1 Instruct Cache", "LLC", "D TLB", "Instruct Cache", "Y"]]
...
#legplot1 = list_conv1
#plt.plot(legplot1)
#plt.title("Samples Before Smoothing Data with Rolling Average (with rootkit)")
#plt.xlabel("Samples")
...
legplot2 = list_conv2
plt.plot(legplot2, color="purple")
plt.title("Before Smoothing Data with Rolling Average (without rootkit)")
plt.xlabel("Samples")
plt.ylabel("Cache Misses")
...
#legplot3 = no_nans
legplot4 = no_nans1
#plt.plot(legplot3, label= "Rootkit")
plt.plot(legplot4, label="No Rootkit", color="purple")
plt.title("Smoothing Data with Moving Average (without Rootkit)")
plt.xlabel("Samples")
plt.ylabel("Cache Misses")
#plt.plot(legplot2)
plt.legend()
plt.savefig('data6.png')
plt.show()
...
legplot6 = list_conv4
plt.plot(legplot2, color="orange")
plt.title("Before Smoothing Data with Rolling Average (without rootkit)")
plt.xlabel("Samples")
...
SMA_Cache_Miss2 = data["Instruct"]
window_size2 = 200
windows2 = SMA_Cache_Miss2.rolling(window_size2)
moving_averages2 = windows2.mean()
moving_averages_list2 = moving_averages2.tolist()
no_nans2 = moving_averages_list1[window_size2 -1:]

legplot8 = no_nans2
#plt.plot(legplot3, label= "Rootkit")
plt.plot(legplot8, label="No Rootkit", color="orange")
plt.title("Smoothing Data with Moving Average (without Rootkit)")
plt.xlabel("Samples")
plt.ylabel("Instructions")
#plt.plot(legplot2)
plt.legend()
plt.savefig('data8.png')
plt.show()
